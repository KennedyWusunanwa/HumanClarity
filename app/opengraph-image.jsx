    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            >
              ...
              <span
                style={{
                  background: 'linear-gradient(135deg, #a8c7fa 0%, #7c9fff 40%, #a78bff 100%)',
            ...
            >
              Humanize AI text instantly. Bypass Turnitin, GPTZero, Originality.ai
              and more — in seconds.
            </p>
          </div>
        ...
        >
          ...
          {/* Text lines */}
          {[
            { w: '100%', c: 'rgba(168,199,250,0.22)' },
            { w: '82%', c: 'rgba(168,199,250,0.22)' },
            { w: '91%', c: 'rgba(168,199,250,0.22)' },
            { w: '70%', c: 'rgba(168,199,250,0.22)' },
          ].map((l, i) => (
            <div
              key={i}
              style={{
